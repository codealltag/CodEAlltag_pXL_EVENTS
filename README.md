# CodE Alltag<sub>XL</sub> EVENTS

CodE Alltag<sub>XL</sub> EVENTS is part of CodE Alltag, a German-language email corpus. It contains ~246.000 automatically pseudonymized emails on topics related to events of the day.
